...
urlpatterns = [
    ...
    url(r'^panelcentralny/stok/(\d+)/$', views.product_view, name='Widok produktu'),
    url(r'^panelcentralny/zarzadzanie/$', views.management, name='Zarządzanie'),
    url(r'^panelcentralny/zarzadzanie/zmianacen/$', views.price_changes, name='Zmiana cen'),
    url(r'^panelcentralny/zarzadzanie/zmianacen/(\d+)/$', views.priceandpromo, name='Zmiana ceny'),
    url(r'^panelcentralny/zarzadzanie/zamowienia/$', views.orders_stand_choice, name='Wybór stoiska zamówienia'),
    url(r'^panelcentralny/zarzadzanie/zamowienia/(.*)/$', views.orders_plu_choice, name='Wybór plu zamówienia'),
    url(r'^panelcentralny/zarzadzanie/zamowienia/(.*)/(\d+)/$', views.orders, name='Zamówienia'),
